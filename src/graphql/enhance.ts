...
const relationResolversInfo = {
  ...
  Comment: ["author", "book"],
  Post: ["author"],
  User: ["user_posts", "user_comments", "user_books", "user_ratings"]
};
...
const outputsInfo = {
  ...
  UserCount: ["user_posts", "user_comments", "user_books", "user_ratings"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_books", "user_ratings"],
  UserOrderByWithRelationInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_books", "user_ratings"],
  ...
  UserCreateInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_books", "user_ratings"],
  UserUpdateInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_books", "user_ratings"],
  ...
  UserCreateNestedOneWithoutUser_booksInput: ["create", "connectOrCreate", "connect"],
  ...
  UserUpdateOneRequiredWithoutUser_booksNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  UserCreateNestedOneWithoutUser_ratingsInput: ["create", "connectOrCreate", "connect"],
  BookCreateNestedOneWithoutBook_ratingsInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutUser_ratingsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  BookUpdateOneRequiredWithoutBook_ratingsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  UserCreateNestedOneWithoutUser_commentsInput: ["create", "connectOrCreate", "connect"],
  BookCreateNestedOneWithoutBook_commentsInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutUser_commentsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  BookUpdateOneRequiredWithoutBook_commentsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  UserCreateNestedOneWithoutUser_postsInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutUser_postsNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  UserCreateWithoutUser_booksInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_ratings"],
  UserCreateOrConnectWithoutUser_booksInput: ["where", "create"],
  ...
  UserUpsertWithoutUser_booksInput: ["update", "create"],
  UserUpdateWithoutUser_booksInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_ratings"],
  ...
  UserCreateWithoutUser_ratingsInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_books"],
  UserCreateOrConnectWithoutUser_ratingsInput: ["where", "create"],
  ...
  UserUpsertWithoutUser_ratingsInput: ["update", "create"],
  UserUpdateWithoutUser_ratingsInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_comments", "user_books"],
  ...
  UserCreateWithoutUser_commentsInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_books", "user_ratings"],
  UserCreateOrConnectWithoutUser_commentsInput: ["where", "create"],
  ...
  UserUpsertWithoutUser_commentsInput: ["update", "create"],
  UserUpdateWithoutUser_commentsInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_posts", "user_books", "user_ratings"],
  ...
  UserCreateWithoutUser_postsInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_comments", "user_books", "user_ratings"],
  UserCreateOrConnectWithoutUser_postsInput: ["where", "create"],
  UserUpsertWithoutUser_postsInput: ["update", "create"],
  UserUpdateWithoutUser_postsInput: ["userid", "created_at", "updated_at", "username", "email", "password", "uid", "email_verified", "is_anonymous", "display_name", "photo_url", "user_comments", "user_books", "user_ratings"],
